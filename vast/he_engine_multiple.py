...
import numpy as np
import wandb
from he_datasets_multiple import data_loader
from he_models_multiple import BERTSeqClf
import gc
...
class Engine:
    ...
    def train_epoch(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            stances = batch['stances'].to(self.device)  # shape: (batch, 3)
            ...
            # logits shape: (batch, 3, num_labels); flatten for loss computation
            batch_size, num_targets, num_labels = logits.shape
            logits = logits.view(batch_size * num_targets, num_labels)
            stances = stances.view(batch_size * num_targets)
    ...
    def eval(self, phase='val'):
        ...
        if phase == 'test':
            ...
            for i in range(3):
                ...
                # Use the aggregated few_shot_all array here, not the current batch
